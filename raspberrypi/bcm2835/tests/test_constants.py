...
class TestBCM2835Constants(unittest.TestCase):
  ...
  def test_constants(self):
    ...
    self.assertEqual(RPI_B_PLUS_GPIO_J8_03, 2)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_05, 3)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_07, 4)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_08, 14)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_10, 15)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_11, 17)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_12, 18)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_13, 27)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_15, 22)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_16, 23)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_18, 24)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_19, 10)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_21, 9)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_22, 25)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_23, 11)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_24, 8)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_26, 7)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_29, 5)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_31, 6)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_32, 12)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_33, 13)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_35, 19)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_36, 16)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_37, 26)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_38, 20)
    self.assertEqual(RPI_B_PLUS_GPIO_J8_40, 21)


    self.assertEqual(SPI_BIT_ORDER_LSBFIRST, 0)
    self.assertEqual(SPI_BIT_ORDER_MSBFIRST, 1)

    self.assertEqual(SPI_MODE0, 0)
    self.assertEqual(SPI_MODE1, 1)
    self.assertEqual(SPI_MODE2, 2)
    self.assertEqual(SPI_MODE3, 3)

    self.assertEqual(SPI_CS0, 0)
    self.assertEqual(SPI_CS1, 1)
    self.assertEqual(SPI_CS2, 2)
    self.assertEqual(SPI_CS_NONE, 3)

    self.assertEqual(SPI_CLOCK_DIVIDER_65536, 0)
    self.assertEqual(SPI_CLOCK_DIVIDER_32768, 32768)
    self.assertEqual(SPI_CLOCK_DIVIDER_16384, 16384)
    self.assertEqual(SPI_CLOCK_DIVIDER_8192, 8192)
    self.assertEqual(SPI_CLOCK_DIVIDER_4096, 4096)
    self.assertEqual(SPI_CLOCK_DIVIDER_2048, 2048)
    self.assertEqual(SPI_CLOCK_DIVIDER_1024, 1024)
    self.assertEqual(SPI_CLOCK_DIVIDER_512, 512)
    self.assertEqual(SPI_CLOCK_DIVIDER_256, 256)
    self.assertEqual(SPI_CLOCK_DIVIDER_128, 128)
    self.assertEqual(SPI_CLOCK_DIVIDER_64, 64)
    self.assertEqual(SPI_CLOCK_DIVIDER_32, 32)
    self.assertEqual(SPI_CLOCK_DIVIDER_16, 16)
    self.assertEqual(SPI_CLOCK_DIVIDER_8, 8)
    self.assertEqual(SPI_CLOCK_DIVIDER_4, 4)
    self.assertEqual(SPI_CLOCK_DIVIDER_2, 2)
    self.assertEqual(SPI_CLOCK_DIVIDER_1, 1)

    self.assertEqual(I2C_CLOCK_DIVIDER_2500, 2500)
    self.assertEqual(I2C_CLOCK_DIVIDER_626, 626)
    self.assertEqual(I2C_CLOCK_DIVIDER_150, 150)
    self.assertEqual(I2C_CLOCK_DIVIDER_148, 148)

    self.assertEqual(I2C_REASON_OK, 0x00)
    self.assertEqual(I2C_REASON_ERROR_NACK, 0x01)
    self.assertEqual(I2C_REASON_ERROR_CLKT, 0x02)
    self.assertEqual(I2C_REASON_ERROR_DATA, 0x04)

    self.assertEqual(PWM_CLOCK_DIVIDER_32768, 32768)
    self.assertEqual(PWM_CLOCK_DIVIDER_16384, 16384)
    self.assertEqual(PWM_CLOCK_DIVIDER_8192, 8192)
    self.assertEqual(PWM_CLOCK_DIVIDER_4096, 4096)
    self.assertEqual(PWM_CLOCK_DIVIDER_2048, 2048)
    self.assertEqual(PWM_CLOCK_DIVIDER_1024, 1024)
    self.assertEqual(PWM_CLOCK_DIVIDER_512, 512)
    self.assertEqual(PWM_CLOCK_DIVIDER_256, 256)
    self.assertEqual(PWM_CLOCK_DIVIDER_128, 128)
    self.assertEqual(PWM_CLOCK_DIVIDER_64, 64)
    self.assertEqual(PWM_CLOCK_DIVIDER_32, 32)
    self.assertEqual(PWM_CLOCK_DIVIDER_16, 16)
    self.assertEqual(PWM_CLOCK_DIVIDER_8, 8)
